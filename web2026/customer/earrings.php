...
<head>
    ...
    <title>Earrings | Boutique Luxury</title>
    <!-- Fonts -->
    ...
    <style>
        ...
        .shop-header-premium {
            ...
            width: 100%;
            height: 400px;
            background-image: url('../images/earings.jpg');
...
<div class="shop-header-premium">
    ...
    <div class="header-content">
        <h1>Earrings</h1>
        <p>Details that make you glow</p>
...
<div class="product-grid">
    <?php
    $result = mysqli_query($conn, "SELECT * FROM products WHERE category_id = 4 ORDER BY id DESC");
