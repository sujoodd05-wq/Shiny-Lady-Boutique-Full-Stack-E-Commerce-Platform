...
<head>
    ...
    <title>Bracelets | Boutique Luxury</title>
    <!-- Fonts -->
    ...
    <style>
        .product-container { padding: 60px 10%; background-color: #fcfcfc; }
        .product-grid {
            display: grid;
        ...
        .product-card h3 { font-size: 1rem; font-weight: 500; color: var(--plum-wine); margin-bottom: 10px; }
        .product-card .price { font-weight: 600; color: var(--copper-rose); margin-bottom: 20px; }
        ...
        .stock-label { font-size: 0.8rem; margin-bottom: 15px; }

        .shop-header-premium {
            position: relative;
            width: 100%;
            height: 400px;
            background-image: url('../images/brac.PNG');
...
<div class="product-grid">
    ...
    $result = mysqli_query($conn, "SELECT * FROM products WHERE category_id = 3 ORDER BY id DESC");
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="product-card">
                ...
                <!-- معلومات المنتج بالأسفل (خارج حاوية الصورة) -->
                <div class="info">
