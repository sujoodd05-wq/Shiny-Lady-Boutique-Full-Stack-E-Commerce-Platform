...
<head>
    ...
    <title>Rings | Boutique Luxury</title>
    <!-- Fonts -->
...
<div class="shop-header-premium">
    ...
    <div class="header-content">
        <h1>Rings</h1>
        <p>Pure elegance for your fingers</p>
...
<div class="product-grid">
    ...
    $result = mysqli_query($conn, "SELECT * FROM products WHERE category_id = 2 ORDER BY id DESC");
